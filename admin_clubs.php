<div id='ajax-content'>
     ...
     <?php require_once('connectvars.php'); ?>
          <div class="news-header">
                <div class="news">
                    <form action="add-club.php">
           <div style="text-align: right;margin-top : -1% ;margin-right : 1% ;">
               <input type="submit" id="search-op" value="Add Clubs"></div>
          </form>
                      <?php
          $count=1;
		    ...
		    <tr>
			 <td class="readmore"><a href="update-club.php?id=<?php echo $row['no'];?>">Update</a></td>
		    </tr>
		     </table>
                      <table align="right" cellpadding="8" style="margin-top : 2% ;" cellspacing=="4" bgcolor="white" width="135" height="10">
		    <tr>
                         <td class="edit"><a href="delete-club.php?id=<?php echo $row['no'];?>">Delete</a></td>
		    </tr>
                      </table>
                       <table align="right" cellpadding="8" style="margin-top : 2% ;" cellspacing=="4" bgcolor="white" width="135" height="10">
		    <tr>
                         <td class="edit"><a href="list-club.php?id=<?php echo $row['no'];?>">Participation List</a></td>
		    </tr>
                      </table>
                       </table>
                       <table align="right" cellpadding="8" style="margin-top : 2% ;" cellspacing=="4" bgcolor="white" width="135" height="10">
		    <tr>
                         <td class="edit"><a href="delpart-club.php?id=<?php echo $row['no'];?>">Delete Records</a></td>
		    </tr>
                      </table>
		    <hr>
                 <?php
