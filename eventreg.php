...
<div class="container">
      ...
      <div  class="form">
			...
			<p class="contact"><label for="clubname">Event Name</label></p> 
    			...
    			<input id="rollno" name="rollno" placeholder="Enter University Roll No"  maxlength="10" required="" tabindex="1" type="text" onblur="rollnovalidator()">
