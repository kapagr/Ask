     ...
     <div style="float : center; width : 30% ;">
        <?php require_once('connectvars.php'); ?>
          ...
          $count=1;
		    ...
		    <tr>
			 <td class="readmore"><a href="admin-eventmore.php?id=<?php echo $row['nid'];?>">Read More</a></td>
		    </tr>
		     </table>
                      <table align="right" cellpadding="8" style="margin-top : 2% ;" cellspacing=="4" border="1" bgcolor="white" width="135" height="10">
		    <tr>
                         <td class="edit"><a href="edit1.php?id=<?php echo $row['nid'];?>">Update</a></td>
		    </tr>
                      </table>
                      <table align="right" cellpadding="8" style="margin-top : 2% ;" cellspacing=="4" border="1" bgcolor="white" width="135" height="10">
                     <tr>
                         <td class="edit"><a href="delete1.php?id=<?php echo $row['nid'];?>">Delete</a></td>
		    </tr>
		     </table>
                     <hr>
                    <?php
