     ...
     <?php  require_once('connectvars.php'); ?>
          <div class="news-header">
           ...
           <div style="text-align: right;margin-top : -1% ;margin-right : 1% ;">
               <input type="submit" id="search-op" value="Add Visited Company"></div>
          </form>
                      <?php
          $count=1;
	    ...
	    $str=date("Y-m-d");
            ...
            $result=mysqli_query($dbc,$query) or die(mysqli_error());
               ...
               ?>
                  ...
                  echo $filename;?>
                     ...
                     Visited Date :-<?php echo '<font color="black">'.$dt.'</font>' ;?>
                     </div>
                     <br>
		    ...
		    <tr>
                         ...
                         <table align="right" cellpadding="8" style="margin-top : 2% ;background-color : white ;" cellspacing=="4" width="135" height="10">
		    <tr>
			 <td class="readmore"><a href="placed-student.php?id=<?php echo $row['Cno'];?>">Placed Student</a></td>
		    </tr>
		     </table>
		    <hr>
                 <?php
